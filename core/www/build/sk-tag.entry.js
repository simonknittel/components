import { r as registerInstance, h } from './index-b18d8697.js';
...
const Tag = class {
  ...
  render() {
    return (h("div", { class: `wrapper ${this.description ? 'has-description' : ''}`, lang: "en" }, h("sk-typography", { class: "content", size: "14-responsive" }, h("slot", null)), this.description ?
