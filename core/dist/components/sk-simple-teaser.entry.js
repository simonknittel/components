import { r as registerInstance, h, e as Host } from './index-b18d8697.js';
...
const SimpleTeaser = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: "text" }, h("sk-typography", { class: "heading", as: "h3" }, this.heading, this.badge &&
      h("span", { class: "badge" }, this.badge)), h("div", { class: "tags" }, this.tags.map(item => h("sk-tag", null, item))), h("slot", null)), h("a", { href: this.href, target: this.target, rel: this.rel, class: "link" }, h("sk-typography", null, this.linkText))));
  }
};
