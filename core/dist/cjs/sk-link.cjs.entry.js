...
const Link = class {
  ...
  render() {
    ...
    return (index.h("a", { href: this.href, target: this.target, rel: this.rel, class: classArray.join(' '), onClick: this.onClick.bind(this) }, this.iconPosition !== 'right' ? this.icon : '', index.h("sk-typography", { class: "text" }, index.h("slot", null)), this.iconPosition == 'right' ? this.icon : ''));
  }
};
Link.style = linkCss;

exports.sk_link = Link;
