...
const Tag = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("sk-typography", { size: "14-responsive" }, index.h("slot", null)), index.h("sk-typography", { class: "tooltip", size: "12-responsive" }, this.description)));
  }
};
Tag.style = tagCss;
