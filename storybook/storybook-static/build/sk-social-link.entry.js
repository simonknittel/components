import { r as registerInstance, h, g as getAssetPath } from './index-8c43d675.js';
...
const SocialLink = class {
    ...
    render() {
        ...
        return (h("a", { href: this.url, target: "_blank", rel: "noopener", class: {
                compact: this.compact,
                'compact-on-small': this.compactOnSmall,
            } }, h("span", { class: "icon" }, h("svg", { viewBox: "0 0 " + viewbox[this.icon] }, h("use", { xlinkHref: getAssetPath(`./assets/${this.icon}-brands.svg`) + '#id' }))), h("sk-typography", { class: "text" }, this.text)));
    }
