...
const SimpleTeaser = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "text" }, h("sk-typography", { class: "heading", as: "h3" }, this.heading, this.badge &&
            h("sk-badge", null, this.badge)), h("sk-tag-list", { items: this.tags }), h("slot", null)), h("a", { href: this.href, target: this.target, rel: this.rel, class: "link" }, h("sk-typography", null, this.linkText))));
    }
};
