import { r as registerInstance, f as createEvent, h } from './index-8c43d675.js';
...
const Link = class {
    ...
    render() {
        ...
        return (h("a", { href: this.href, target: this.target, rel: this.noopener, class: classArray.join(' '), onClick: this.onClick.bind(this) }, this.iconPosition !== 'right' ? this.icon : '', h("sk-typography", { class: "text" }, h("slot", null)), this.iconPosition == 'right' ? this.icon : ''));
    }
};
Link.style = linkCss;
